...
public class MapChangeSize extends SurfaceView implements
    ...
    public MapChangeSize(Context context, AttributeSet attrs) {
        super(context, attrs);
        mSurHolder = getHolder();
        mSurHolder.addCallback(this);
        this.setOnTouchListener(this);
        mBitmap = BitmapFactory.decodeResource(getResources(), R.drawable.f2_map);
        setBitmap(mBitmap);
    }
    ...
    public void setBitmap(Bitmap b) {
        ...
        synchronized (MapChangeSize.class) {
            mBitmap = b;
